...
const fs = require('fs');
const { v4: uuidv4 } = require('uuid'); // Needed to generate fresh Request IDs
...
// This config is critical to bypass basic bot detection
const axiosConfig = {
    headers: {
    ...
    try {
        for (const categoryUrl of CATEGORY_URLS) {
            ...
            while (hasProducts) {
                ...
                // This replaces the old ID in the link with a new UUID
                ...
                page++;
                // Small delay to be polite (100ms is usually fine for Axios)
